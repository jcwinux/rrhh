...
<fieldset>
	<legend class="section">
		Usuarios
		<button id="agregar_usuario" name="agregar_usuario" type="button" class="btn btn-transparent btn-xs pull-right" data-toggle="modal" data-target="#modalUsuario" data-backdrop="static">
