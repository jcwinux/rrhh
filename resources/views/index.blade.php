            ...
            <ul id="side-nav" class="side-nav">
                ...
                <li class="panel ">
                    ...
                    <ul id="special-collapse" class="panel-collapse collapse ">
                        ...
                        <li><a href="../dark/index.html" data-no-pjax title="Light Blue Transparent Dark version">Dark <sup class="text-warning fw-bold">new</sup></a></li>
                    ...
                    <div class="body">
                        <div id="chat" class="chat">
                            ...
                            <footer class="chat-footer row">
                                <div class="col-xs-9">
                                    <input id="new-message" type="text" class="form-control" placeholder="Enter your message..">
                                </div>
                                <div class="col-xs-3">
                                    <button type="button" id="new-message-btn" class="btn btn-danger btn-block">Send</button>
                                </div>
                            </footer>
                        </div>
                    </div>
            ...
            <div class="col-lg-4">
                <section class="widget large">
                    <header>
                        ...
                        <div class="actions">
                            <button class="btn btn-default btn-xs">Show All <i class="fa fa-arrow-down"></i></button>
                        </div>
                    </header>
                    <div class="body">
